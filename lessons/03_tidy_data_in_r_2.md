...
5. Now group by state and analyte, then summarize the `result`, `lon_dd83`, and `lat_dd83` by calculating the mean for those. The newly created column names should be, `result_mean`, `long_mean` and `lat_mean`.
